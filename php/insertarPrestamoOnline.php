...
for ($j=0; $j <  count($jsonSimple) ; $j++) {
	...
	if($jsonSimple[$j]['razon']==='Desembolso'){
		...
		$sqlCuotas=$sqlCuotas."INSERT INTO `prestamo_cuotas`(`idCuota`, `idPrestamo`, `cuotFechaPago`, `cuotCuota`, `cuotFechaCancelacion`, `cuotPago`, `cuotCapital`,`cuotInteres`, `cuotSaldo`, `cuotVo`, `cuotObservaciones`,`idTipoPrestamo`, `cuotSeg`) VALUES (null,$idPrestamo,'{$nueva->format('Y-m-d')}',{$jsonSimple[$j]['cuota']},'0000-00-00',0, {$capitalPartido}, {$intGanado}, {$saldo}, 0, '', 79, {$seguro} );";
	}
