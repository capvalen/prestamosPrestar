...
display: inline-block!important; font-size: 18px!important;
    /* width: 95%!important; */}
.icoTransparent{display: inline-block; color: #555555c2; font-size: 16px;
		...
		<div class="col-md-12">
			<div class="wello login-box " style="color: #673ab7"  >
				...
				<h3 class="text-center" style="margin-top: 10px;margin-bottom: 0px;">Prestar Huancayo</h3>
					...
					<div class="col-xs-8">
						<div class="text-center" style="padding-top: 20px;"><span >Web app de «Infocat» <strong>Local: BotÍn de oro</strong></span></div>
